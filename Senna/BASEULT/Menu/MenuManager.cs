...
namespace Menu
{
    public class MenuManager : BaseUlt
    {
        ...
        public static void LoadMenu()
        {
            ...
            //Menu
            BaseUltMenu = new EnsoulSharp.SDK.MenuUI.Menu("xDreammsBaseUlt", "BaseUlt", true);
            ...
            barMenu.Add(new MenuSlider("BarSettingsX", "X Offsets", 20,0,3000)).GetValue<MenuSlider>().ValueChanged += OnValueChanged;
            barMenu.Add(new MenuSlider("BarSettingsY", "Y Offsets", 300, 0, 3000)).GetValue<MenuSlider>().ValueChanged+= OnValueChanged2;
