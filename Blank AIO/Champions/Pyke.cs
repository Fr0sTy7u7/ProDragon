...
namespace BlankAIO.Champions
{
    internal class Pyke
    {
        ...
        public static void OnLoad()
        {
            ...
            Game.Print("BlankAIO.Pyke Loaded! This version is using the SDK orbwalker, please select 'SDK' with Orbwalker Selector.");
        ...
        private static void Combo()
        {
            ...
            if (MainMenu["Combo Settings"]["comboR"].GetValue<MenuBool>().Enabled && R.IsReady())
            {
                ...
                if (rtarget != null && rtarget.IsValidTarget(R.Range))
                {
                    ...
                    if (!rtarget.IsDead  && rtarget.IsVisible && rtarget.IsHPBarRendered)
                    {
