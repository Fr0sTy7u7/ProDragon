...
namespace SupportAIO.Champions
{
    class Rakan : Champion
    {
        ...
        protected override void SetSpells()
        {
            ...
            Q.SetSkillshot(0.25f, 60, 1800, true, SkillshotType.Line, HitChance.None);
            W.SetSkillshot(0.25f, 50, 1800, false, SkillshotType.Circle, HitChance.None);
